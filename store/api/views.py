...
from store.models.C2BPayments import C2BPayments
from store.models.Online import Online
from store.api.serializers import OnlineSerializer,C2BPaymentSerializer


class CallbackUrlAPIView(CreateAPIView):
    ...
    def create(self, request):
        ...
        from store.models import Online

        our_model = Online.objects.create(
