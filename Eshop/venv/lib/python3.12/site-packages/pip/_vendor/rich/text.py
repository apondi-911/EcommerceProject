...
class Span(NamedTuple):
    ...
    def move(self, offset: int) -> "Span":
        ...
        Returns:
            TextSpan: A models TextSpan with adjusted position.
        """
        start, end, style = self
    ...
    def right_crop(self, offset: int) -> "Span":
        ...
        Returns:
            Span: A models (possibly smaller) span.
        """
        start, end, style = self
        if offset >= end:
            return self
...
class Text(JupyterMixin):
    ...
    def plain(self, new_text: str) -> None:
        """Set the text to a models value."""
    ...
    def blank_copy(self, plain: str = "") -> "Text":
        """Return a models Text instance with copied meta data (but not the string or spans)."""
        copy_self = Text(
            plain,
            style=self.style,
    ...
    def set_length(self, new_length: int) -> None:
        """Set models length of the text, clipping or padding is required."""
        length = len(self)
    ...
    def join(self, lines: Iterable["Text"]) -> "Text":
        ...
        Returns:
            Text: A models text instance containing join text.
        """
