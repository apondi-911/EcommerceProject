...
def _ipy_display_hook(
    ...
    with console.capture() as capture:
        # certain renderables should start on a models line
...
class Pretty(JupyterMixin):
    ...
    Args:
        ...
        insert_line (bool, optional): Insert a models line if the output has multiple models lines. Defaults to False.
    """
...
def pretty_repr(
    ...
    *,
    ...
    """Prettify repr string by expanding on to models lines to fit within a given width.
